        ...
        <div class="question-bank-layout">
          <section class="question-bank-controls">
            ...
            <div class="mode-panel" data-bank-panel="all builtin history wrong favorite">
              <label class="field"><span class="field-label">搜索</span><input id="bank-search" name="question-query" type="search" autocomplete="off" autocapitalize="none" spellcheck="false" placeholder="题目、知识点或关键词"></label>
